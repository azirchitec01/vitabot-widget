...
(function() {
    ...
    const welcomeScreenHTML = `
        ...
        <div class="user-registration">
            <h2 class="registration-title">Composez vos coordonnées pour commencer</h2>
            <form class="registration-form">
                <div class="form-field">
                    <label class="form-label" for="chat-user-name">Nom & Prénom</label>
    ...
    async function handleRegistration(event) {
        ...
        try {
            ...
            errorMessage.textContent = "Désolé, nous n'avons pas pu nous connecter au serveur. Veuillez réessayer plus tard.";
    ...
    async function submitMessage(messageText) {
        ...
        try {
            ...
            const errorMessage = document.createElement('div');
            errorMessage.className = 'chat-bubble bot-bubble';
            errorMessage.textContent = "Désolé, nous n'avons pas pu envoyer votre message. Veuillez réessayer.";
            messagesContainer.appendChild(errorMessage);
            messagesContainer.scrollTop = messagesContainer.scrollHeight;
        } finally {
